 ...
 * @author Avishka
 */
public class DailyInfo extends javax.swing.JFrame {

    /**
     * Creates new form DailyInfo
     */
    ...
    public DailyInfo(Main main) {
        ...
        try {
            this.ordersDetails = dailyInfoController.getAllOrdersToday(today);
        ...
        try {
            this.suppliersItemsDetails = dailyInfoController.getAllSuppliersToday(today);
        } catch (SQLException ex) {
            Logger.getLogger(DailyInfo.class.getName()).log(Level.SEVERE, null, ex);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(DailyInfo.class.getName()).log(Level.SEVERE, null, ex);
        ...
        showProfitInfoToday(today);
        showSpecialNoticesToday(today);
    ...
    private void initComponents() {
        ...
        mainLabel.setText("Daily Information");
        ...
        mainLabel4.setText("Special Notice about goods");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(mainLabel4, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 243, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(mainLabel4, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DailyInfo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void showSpecialNoticesToday(String today) {
        try {
            ArrayList<ItemDTO> itemDTOs = dailyInfoController.getAllItems();
            if (itemDTOs.size()== 0) {
                TextArea1.setText("All Items have more than lower limit.");
            }else{
                for (ItemDTO itemDTO : itemDTOs) {
                    TextArea1.append("Item : "+itemDTO.getIid()+"-"+itemDTO.getName()+" has less than "+itemDTO.getLowerLimit()+" items.("+itemDTO.getNoOfItems()+" items left)\n");
                }
            }
        } catch (Exception ex) {
            Logger.getLogger(DailyInfo.class.getName()).log(Level.SEVERE, null, ex);
